...
/// </summary>
public class SvtSerialPortAdapter : IStreamResource
{
    /// <summary>
    /// Creates new line.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SvtSerialPortAdapter"/> class.
    /// </summary>
    /// <param name="serialPort">The serial port.</param>
    public SvtSerialPortAdapter(SerialPortRx serialPort)
    {
