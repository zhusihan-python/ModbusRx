...
/// <summary>
/// ReadSvtRegisterResponse.
/// </summary>
/// <seealso cref="ModbusRx.Message.ISvtMessage" />
public class ReadSvtRegisterResponse : AbstractSvtMessageWithData<SvtDataCollection>, ISvtMessage
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ReadSvtRegisterResponse"/> class.
    /// </summary>
    public ReadSvtRegisterResponse()
    {
    }
    ...
    public ReadSvtRegisterResponse(ushort transactionId, ushort functionCode, byte extendCode, byte masterAddress, byte slaveAddress, byte byteCount, SvtDataCollection data)
