...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ReadDeviceIdRequest"/> class.
    /// </summary>
    ...
    public ReadDeviceIdRequest(byte functionCode, byte extendCode, byte slaveAddress, ushort startAddress, ushort numberOfPoints)
